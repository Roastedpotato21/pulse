...
Pulse is pre-1.0 beta software. Only the latest released version receives
security fixes. The local single-user CLI is the sole supported public-beta
...
characters. Multi-tenant hosting is unsupported until tenant isolation,
centralized observability, load and recovery exercises, and an independent
